...
export const FileInput = ({
  ...
  return (
    <label className="label-grid grid my-2 gap-x-2 items-center">
      ...
      <div
        className={`w-full h-auto flex items-center shadow-md bg-gray-50 hover:bg-gray-100 caret-yellow-500 focus-within:ring-2 focus-within:ring-yellow-500 focus-within:ring-offset-2 border-gray-200 border-2 rounded-md p-2${
          className ? ` ${className}` : ''
        }`}
      >
        <input
